                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  <button
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.target.style.boxShadow = '0 4px 12px rgba(255, 122, 0, 0.15)';
                    }}
                    onMouseLeave={(e) => {
                    ...
                    title="Share survey"
                  >
                    <FaShareAlt style={{ fontSize: 'clamp(12px, 3vw, 14px)' }} />
                  </button>
                  <button
                    type="button"
                    ...
                    title="Report survey"
                  >
                    <FaFlag style={{ fontSize: 'clamp(12px, 3vw, 14px)' }} />
                  </button>
                </div>
              </div>
                ...
                {questions.length > 0 && questions.map((q, idx) => {
                  ...
                  return (
                    <span key={idx} style={{
                      ...
                      {typeIcons[q.type] || '❓'} {typeLabels[q.type] || q.type}
                    </span>
                  );
                })}
              </div>
                            ...
                            return (
                              ...
                              >
                                ...
                                <div style={{
                                  ...
                                  height: '20px',
                                  borderRadius: '50%',
                                  border: isSelected ? '6px solid #FF7A00' : '2px solid #E8E8E8',
                            ...
                            return (
                              ...
                              >
                                ...
                                <div style={{
                                  ...
                                  height: '20px',
                                  borderRadius: '6px',
                                  border: isSelected ? '2px solid #FF7A00' : '2px solid #E8E8E8',
                                  background: isSelected ? '#FF7A00' : 'transparent',
                                  display: 'flex',
                                  alignItems: 'center',
                                  justifyContent: 'center',
